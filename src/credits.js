var creditsState = {
    create: function() {
        ...
        this.creatorName = game.add.text(game.world.centerX, 230, 'Bhoopathy.s (21me02),  mohamedafzal (21ce03)  balasubra mani (21at02)', {
            fill: '#fff',
            fontSize: 48
        });
        ...
        this.musicCreatorName = game.add.text(game.world.centerX, 430, 'lockdown mashup', {
            fill: '#fff',
            fontSize: 48
        });
